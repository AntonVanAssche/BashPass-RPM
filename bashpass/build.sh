...
cp -r "BashPass/${NAME}" "${NAME}-${VERSION}"
cp -r "BashPass/docs/${NAME}.1.gz" "${NAME}-${VERSION}"
cp -r "BashPass/docs/${NAME}.conf.1.gz" "${NAME}-${VERSION}"
cp -r "BashPass/config/${NAME}.conf" "${NAME}-${VERSION}"
